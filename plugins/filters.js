...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        let banned = jid.find( Jid => Jid === message.jid);
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '918921567978s.whatsapp.net') {
...
const array = ['name entha','Dai','mrng','muthe','nice','Kozh','Sticker','poda','podo','ariyo','delete','kopp','How','Chunk','chunk','Rashi','bgm','Bgm','Life','life','Helo','King','Kooi','Welcome','welcome','Love','Paatt','song','Raashii','Thamasha','Hisham','big fan','Time','Umma','time','charlie','gd n8','kar98','love u','Endi','endi','noob','Poweresh','Perfect ok','perfect ok','power','saji','sed','single','waiting','Myr','myr','Malappuram','uyir','thug','avastha','Moodesh','sketched','Cr7','Z aayi','manasilayo','Hi','Hlo','Poda','nirtheda','Aarulle','Cr7 back','Portugal','ennitt','Boss','Haters','ayn','Kgf','Ayyo','Akshay uyir','sed bgm','Messi','Hehe','hehe','Set aano','welcome','set aano','Shadow','Bot myren','Venda','venda','chadhi','Chadhi','Hbday','hbday','Bot','R yyi padicho','Myre','myre','Umbi','umbi','parayatte','Fresh','fresh','Ok da','Feel aayi','feel aaayi','Scene','scene','Ok bei','ok bei','Da','Kozhi','kozhi','adi','Adi','kali','Kali','thantha','Thantha','Aysheri','aysheri','thund','Thund','thot','Thot','sneham','Sneham','pm','Pm','paatt','Paatt','njan','Njan','life','Life','Killadi','killadi','good bye','Good bye','evide','Evide','achan','Achan','kunna','Kunna','broken','Broken','why','Why','enth patti','Enth patti','pani','Pani','padicho','Padicho','paad','Paad','Chatho','chatho','lover','Lover','nanayikoode','Nanayikoode','Die','die','hate','Hate','Lamiya engineering','lamiya engineering','nallath','Nallath','Neymer','neymer','patti','Patti','poora','Poora','Rohit','rohit','thall','Thall','Theri','theri','potte','Potte','Dai','Di','Eda','Ee','Entha cheyya','Fan','Fek','Fen','Ha','Hacker','Hbd','He','Hy','Ichu','Kk','Men','Njr','Oh no','Paat','Panni','Podai','Sarassu','Sarasu','Set','Caption','caption','onn poyi','Onn poyi','problem','Problem','Chill','chill','help','Help','Kunda','kunda','povano','sthalam','Sthalam','tholvi','Tholvi','vannu','Vannu','Chiri','malayalam','Malayalam','vaa','Vaa','bot','lub','Ayin','thyr','Thyr','Sad','sad','Sed','kundan','left','mathi','njn','oombi','over','putt','rascal','wow','vada','scene','kiss','Kiss','baby','Baby','hi','voice','love','Admin','alive','admin','Remove','remove','boss','sorry','Sorry','Owner','owner','Gud nyt','dream','Dream','Zara','Avastha','Bye','bye','Sry','Va','Vaa','Vava','Sticker','Veeran','Vidhi','Wait','Waiting','adima','ara','baby','bie','care','chatho','don','enth','fd','ff','ijathi','Yaar','jithin']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['Kozhi','Bye','bye','Dai','Poli','Dance','Gd mrng','Skba','Ara','Poyi','Shadow','myr','Sticker','poda','podi','Pain','girl','asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Hlo','Kill','kill','kiss','line','love','mwolu','Mwolu','single','tha','thund','z','Z','bie','Bie','Bomb','jithin']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
